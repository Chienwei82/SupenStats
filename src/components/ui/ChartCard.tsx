...
export function ChartCard({ title, subtitle, description, children }: ChartCardProps) {
  return (
    <div
      className="bg-white dark:bg-[#25293c] rounded-xl border border-gray-200 dark:border-[#34324a] p-6 shadow-md dark:shadow-xl dark:shadow-black/30"
      role="group"
