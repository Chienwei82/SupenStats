...
export function ChartNote({ noteId }: Props) {
  ...
  return (
    <details open className="group mt-4 rounded-lg border border-blue-200 dark:border-[#2b2a3e] bg-blue-50 dark:bg-[#262a3a]">
      <summary className="flex items-center justify-between gap-2 px-4 py-2.5 cursor-pointer text-sm font-medium text-blue-900 dark:text-[#89ddff] select-none">
